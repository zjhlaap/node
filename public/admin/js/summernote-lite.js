  ...
  var dropdownButton = function (opt, callback) {
      return buttonGroup([
          button({
              ...
              contents: opt.title + ' ' + icon('note-user-caret'),
              tooltip: opt.tooltip,
              data: {
                  toggle: 'dropdown'
              }
      ...
      $node.html([
          ...
          (options.title
              ? '    <div class="note-modal-header">' +
                  '      <button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-user-close"></i></button>' +
  ...
  */
  ...
  $$1.summernote = $$1.extend($$1.summernote, {
      ...
      options: {
          ...
          icons: {
              'align': 'note-user-align',
              'alignCenter': 'note-user-align-center',
              'alignJustify': 'note-user-align-justify',
              'alignLeft': 'note-user-align-left',
              'alignRight': 'note-user-align-right',
              'rowBelow': 'note-user-row-below',
              'colBefore': 'note-user-col-before',
              'colAfter': 'note-user-col-after',
              'rowAbove': 'note-user-row-above',
              'rowRemove': 'note-user-row-remove',
              'colRemove': 'note-user-col-remove',
              'indent': 'note-user-align-indent',
              'outdent': 'note-user-align-outdent',
              'arrowsAlt': 'note-user-arrows-alt',
              'bold': 'note-user-bold',
              'caret': 'note-user-caret',
              'circle': 'note-user-circle',
              'close': 'note-user-close',
              'code': 'note-user-code',
              'eraser': 'note-user-eraser',
              'font': 'note-user-font',
              'frame': 'note-user-frame',
              'italic': 'note-user-italic',
              'link': 'note-user-link',
              'unlink': 'note-user-chain-broken',
              'magic': 'note-user-magic',
              'menuCheck': 'note-user-menu-check',
              'minus': 'note-user-minus',
              'orderedlist': 'note-user-orderedlist',
              'pencil': 'note-user-pencil',
              'picture': 'note-user-picture',
              'question': 'note-user-question',
              'redo': 'note-user-redo',
              'square': 'note-user-square',
              'strikethrough': 'note-user-strikethrough',
              'subscript': 'note-user-subscript',
              'superscript': 'note-user-superscript',
              'table': 'note-user-table',
              'textHeight': 'note-user-text-height',
              'trash': 'note-user-trash',
              'underline': 'note-user-underline',
              'undo': 'note-user-undo',
              'unorderedlist': 'note-user-unorderedlist',
              'video': 'note-user-video'
          }
      }
  });
